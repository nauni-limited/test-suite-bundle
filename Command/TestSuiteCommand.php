...
namespace Nauni\Bundle\NauniTestSuiteBundle\Command;
...
use Nauni\Bundle\NauniTestSuiteBundle\Loader\AttributeClassLoader;
...
class TestSuiteCommand extends Command
{
    ...
    {
        //We will extract things out from here and start improving on them once we have one happy path working.
